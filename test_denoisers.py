...
sys.stdout = f
for i in range(1,25):
    img_name = f'/home/electron/sources/kodak_dataset/kodim{i:02}.png'
    ...
    imageio.imwrite('out/kodim{i:02}_img.png', img)
    imageio.imwrite('out/kodim{i:02}_imgn.png', imgn)
    imageio.imwrite('out/kodim{i:02}_out_gauss.png', out1)
    imageio.imwrite('out/kodim{i:02}_out_bilateral.png', out2)
    imageio.imwrite('out/kodim{i:02}_out_bm3d.png', out3)
    imageio.imwrite('out/kodim{i:02}_out_dncnn.png', out4)
    imageio.imwrite('out/kodim{i:02}_out_mprnet.png', out5)
